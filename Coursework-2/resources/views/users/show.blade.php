            ...
            <div class="w-full md:w-3/12 md:mx-2">
                <div class="bg-white p-3 border-t-4 border-indigo-400">
                    ...
                    @if ($userType == 'AdminProfile')
                        <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">{{ $user->AdminProfile->bio }}</p>
                    @else
                        <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">{{ $user->UserProfile->bio }}</p>
                    @endif
